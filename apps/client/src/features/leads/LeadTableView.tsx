...
const STATUS_CONFIG: Record<string, { bg: string; text: string; dot: string; label: string }> = {
	CLOSED:         { bg: "bg-red-100",     text: "text-red-700",     dot: "bg-red-400",     label: "Deleted" },
	CONVERTED:      { bg: "bg-green-100",   text: "text-green-700",   dot: "bg-green-500",   label: "Converted" },
	DEMO_COMPLETED: { bg: "bg-blue-100",    text: "text-blue-700",    dot: "bg-blue-500",    label: "Demo Done" },
	DEMO_ASSIGNED:  { bg: "bg-violet-100",  text: "text-violet-700",  dot: "bg-violet-500",  label: "Demo Scheduled" },
	DEMO_REQUEST:   { bg: "bg-amber-100",   text: "text-amber-700",   dot: "bg-amber-500",   label: "Demo Request" },
	FORM_FILLED:    { bg: "bg-emerald-100", text: "text-emerald-700", dot: "bg-emerald-500", label: "Form Filled" },
	FORM_SENT:      { bg: "bg-sky-100",     text: "text-sky-700",     dot: "bg-sky-500",     label: "Form Sent" },
};
const DEFAULT_STATUS = { bg: "bg-gray-100", text: "text-gray-600", dot: "bg-gray-400", label: "Follow Up" };
