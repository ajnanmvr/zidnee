...
const defaultPermissionSeeds: PermissionSeed[] = [
	...
	{ name: "Read User", resource: "users", action: "read", description: "Read user information" },
	...
	{ name: "Read Role", resource: "roles", action: "read", description: "Read role information" },
	...
	{ name: "Read Permission", resource: "permissions", action: "read", description: "Read permission information" },
...
export type UserWithRelations = PublicUser & { roles: Role[]; permissions: Permission[] };
