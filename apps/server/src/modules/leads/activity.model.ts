...
const leadActivitySchema = new Schema<LeadActivityDocument>(
	{
		...
		type: {
			type: String,
			required: true,
			enum: ["CREATED", "UPDATED", "FOLLOW_UP_POSTPONED", "STATUS_CHANGED", "ASSIGNED", "DELETED", "FORM_SENT", "DEMO_REQUESTED", "DEMO_SCHEDULED", "DEMO_COMPLETED", "DEMO_REDONE", "ADMISSION_REQUESTED", "ADMISSION_CONFIRMED", "STUDENT_CREATED"],
		},
		performedBy: {
			type: Schema.Types.ObjectId,
			required: true,
